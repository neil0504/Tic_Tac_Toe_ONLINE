...
//            notiObject.put("icon", "temp_icon") // enter icon that exists in drawable only
            ...
            dataObject.put("id", Data.account?.id)
            dataObject.put("name", Data.account?.displayName)
            dataObject.put("email", Data.account?.email)
            dataObject.put("photoURL", Data.account?.photoUrl.toString())
            dataObject.put("token", Data.myToken)
